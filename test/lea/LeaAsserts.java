...
public class LeaAsserts {
	...
	public LeaAsserts assertHasNoErrorUntil(Phase phase) {
		assertHasNoErrorAt(Phase.LEXER);
		if(phase == Phase.LEXER) return this;
		assertHasNoErrorAt(Phase.PARSER);
		if(phase == Phase.PARSER) return this;
		assertHasNoErrorAt(Phase.STATIC);
		if(phase == Phase.STATIC) return this;
		assertHasNoErrorAt(Phase.TYPE);
		if(phase == Phase.TYPE) return this;
		assertHasNoErrorAt(Phase.RUNTIME);
		return this;
	}

	public LeaAsserts assertHasNoError() {
		return assertHasNoErrorUntil(Phase.RUNTIME);
	}
